...
public class Hero{
	...
	for(int i=0;i<3;i++){        
            ...
            left[i] = ImageIO.read(new File("Lyn_Left/Lyn_Right_"+i+".png"));
            }
            for(int i=0;i<2;i++){
                    
            up[i] = ImageIO.read(new File("Lyn_Up/Lyn_Up_"+i+".png"));
            }
            for(int i=0;i<2;i++){

            right[i] = ImageIO.read(new File("Lyn_Right/Lyn_Left_"+i+".png"));
            }
